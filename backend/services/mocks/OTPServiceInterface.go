...
// CheckAndRefreshOTPCode provides a mock function with given fields: userID, otpType, expirationTime
func (_m *OTPServiceInterface) CheckAndRefreshOTPCode(userID uint, otpType string, expirationTime time.Time) (string, error) {
	ret := _m.Called(userID, otpType, expirationTime)
	...
	if rf, ok := ret.Get(0).(func(uint, string, time.Time) (string, error)); ok {
		return rf(userID, otpType, expirationTime)
	}
	if rf, ok := ret.Get(0).(func(uint, string, time.Time) string); ok {
		r0 = rf(userID, otpType, expirationTime)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(uint, string, time.Time) error); ok {
		r1 = rf(userID, otpType, expirationTime)
	} else {
		r1 = ret.Error(1)
	}
...
// GenerateOTP provides a mock function with given fields: userID, otpType, expirationTime
func (_m *OTPServiceInterface) GenerateOTP(userID uint, otpType string, expirationTime time.Time) (string, error) {
	ret := _m.Called(userID, otpType, expirationTime)
