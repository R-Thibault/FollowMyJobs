...
import (
	...
	internalMocks "github.com/R-Thibault/FollowMyJobs/backend/internal/mocks"
...
func TestLogin_SignIn_UserNotFound(t *testing.T) {
	gin.SetMode(gin.TestMode)
	mockUserService := new(serviceMocks.UserServiceInterface)
	mockHashingService := new(internalMocks.HashingServiceInterface)
	mockJWTTokenGenerator := new(internalMocks.JWTTokenGeneratorUtilInterface)
...
func TestLogin_PasswordDoNotMatch(t *testing.T) {
	gin.SetMode(gin.TestMode)
	mockUserService := new(serviceMocks.UserServiceInterface)
	mockHashingService := new(internalMocks.HashingServiceInterface)
	mockJWTTokenGenerator := new(internalMocks.JWTTokenGeneratorUtilInterface)
